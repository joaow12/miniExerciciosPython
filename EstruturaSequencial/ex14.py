...
if(peso > 50):
    print("O valor da multa que você deve pagar é: R$", (peso-50)*4)
    print("Você exedeu o peso limite (50kg) em :", (peso-50), "kg")
else:
    print("O peixe esta abaixo da multa do estado (50kg) e portanto não será necessario pagar multa")